...
os.mkdir('LHC_Net/assets')
os.mkdir('LHC_Net/variables')
os.mkdir('Downloaded_Models/LHC_NetC')
os.mkdir('LHC_NetC/assets')
os.mkdir('LHC_NetC/variables')
...
r = requests.get(url, allow_redirects=True)
open('BDownloaded_Models/LHC_NetC/LHC_Net_Controller.index', 'wb').write(r.content)